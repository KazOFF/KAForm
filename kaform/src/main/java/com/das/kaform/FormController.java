...
import com.das.kaform.controllers.LabeledFieldController;
import com.das.kaform.utils.MessageUtil;
import com.das.kaform.validations.ValidationError;
    ...
    public boolean isValidInput() {
        for (FormSectionController section : getSections()) {
            for (FormElementController element : section.getElements()) {
                if (element instanceof EditTextController) {
                    EditTextController field = (EditTextController)element;
