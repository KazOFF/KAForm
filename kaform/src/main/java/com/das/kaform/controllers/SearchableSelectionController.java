...
import com.das.kaform.utils.MessageUtil;
...
public class SearchableSelectionController extends LabeledFieldController {
     ...
     */
    public SearchableSelectionController(Context ctx, String name, String labelText, String placeholder, SelectionDataSource dataSource) {
    ...
    private void showSelectionDialog(final Context context, final EditText editText) {
        if (items == null) {
            ...
            View searchableList = LayoutInflater.from(context).inflate(R.layout.kaform_searchable_listview, null);
