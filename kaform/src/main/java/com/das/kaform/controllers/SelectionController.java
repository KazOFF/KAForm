...
public class SelectionController extends LabeledFieldController {
     ...
     */
    public SelectionController(Context ctx, String name, String labelText, String prompt, List<String> items, boolean useItemsAsValues) {
        this(ctx, name, labelText, prompt, items, useItemsAsValues ? items : null);
    }
     ...
     */
    public SelectionController(Context ctx, String name, String labelText, String prompt, List<String> items, List<?> values) {
    ...
    protected View createFieldView() {
        ...
        spinnerView.setAdapter(new NothingSelectedSpinnerAdapter(spinnerAdapter, R.layout.kaform_nothing_selected, getContext()));
